...
export const JobController = {
  ...
  // Create job
  createJob: async (req: UserRequest, res: Response) => {
    if (!req.user) {
  ...
  // Update job
  updateJob: async (req: UserRequest, res: Response) => {
    const { id } = req.params;
    const { title, description, location, salary_range, skills } = req.body;
  ...
  // Delete job
  deleteJob: async (req: UserRequest, res: Response) => {
    const { id } = req.params;
  ...
  getJobsByEmployer: async (req: Request, res: Response) => {
